...
<div class="culmn">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#business" id="navbarScrollingDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Service
                        </a>
                ...
                <div class="main_home text-center">
                    <div class="col-md-12">
                        <div class="hello_slid">
                            <div class="slid_item">
                                <div class="home_text ">
                                    <h2 class="text-white">Welcome to <strong>KSS</strong></h2>
                                    <h1 class="text-white">Stock Recommendation</h1>
                                    <h3 class="text-white">- We use <strong> machine learning</strong> to recommend stocks -</h3>
                                </div>
                            ...
                            <div class="slid_item">
                                <div class="home_text ">
                                    <h2 class="text-white">Welcome to <strong>KSS</strong></h2>
                                    <h1 class="text-white">Stock Analysis</h1>
                                    <h3 class="text-white">- We use <strong>NLP</strong> to analyze stocks more accurately -</h3>
                                </div>
                            ...
                            <div class="slid_item">
                                <div class="home_text ">
                                    <h2 class="text-white">Welcome to <strong>KSS</strong></h2>
                                    <h1 class="text-white">Visualization</h1>
                                    <h3 class="text-white">- We use <strong>simple graphs and figures</strong> for ease of viewing -</h3>
                                </div>
    ...
    <!--Featured Section-->
    <section id="features" class="features roomy-70">
        <div class="container">
            <div class="row">
                    <div class="col-md-4">
                        <div class="features_item sm-m-top-30">
                            ...
                            <div class="f_item_text">
                                <h3>AI 주식 비서</h3>
                                <p>머신러닝을 통한 수치 기반 주식 예측은 기본!, 한국어 기반 기사 크롤링 및 자연어 처리를 통한 fine-tuning을 통해
                                주식의 현재상황과 예측을 보여드립니다.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="features_item sm-m-top-30">
                            ...
                            <div class="f_item_text">
                                <h3>내가 원하는 금액으로!</h3>
                                <p>사용자가 원하는 금액을 클릭하면, 그 금액과 일치하는 한 주의 가격을 가진 주식들을 보여드립니다.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="features_item sm-m-top-30">
                            ...
                            <div class="f_item_text">
                                <h3>보기 쉬운 시각화</h3>
                                <p>그래프로 보여드립니다! 점선으로 현재 상황을 보여주고 실선으로 예측 상황을 보여드립니다.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="main_business">
                    ...
                    <div class="col-md-6">
                        <div class="business_item sm-m-top-50">
                            <h2 class="text-uppercase">Our Main Service</h2>
                            <ul>
                                <li><i class="fa fa-arrow-circle-right"></i> <strong> 주식 예측 서비스</strong> </li>
                                <p class="m-top-5">상장일부터 현재까지의 주식 양상과 최근 뉴스 기사의 내용을 분석하여 주가를 예측합니다. </p>
                                <li><i class="fa  fa-arrow-circle-right"></i><strong>주식 추천 서비스</strong>  </li>
                                <p class="m-top-5"> 업종별로 원하는 1주당 금액을 입력하면 그에 알맞은 주식을 추천해 줍니다.</p>
                            ...
                            <div class="business_btn">
                                <a onclick="location='recommend'" class="btn btn-default m-top-20">주식 추천 서비스</a>
                                <a onclick="location='prediction'" class="btn btn-primary m-top-20">주가 예측 서비스</a>
                            </div>
    ...
    <footer id="contact" class=" bg-black p-top-30">
                ...
                <div class="widget_area">
                    <div class="col-md-3">
                        <div class="widget_item widget_about">
                            ...
                            <p> 명지대학교 정보통신공학과 장주희 <br>
                            명지대학교 정보통신공학과 김현정<br>
                            명지대학교 정보통신공학과 남다윤</p>
                        </div>
                    </div>
